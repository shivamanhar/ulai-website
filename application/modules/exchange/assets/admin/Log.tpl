    ...
    <div class="frame_title clearfix">
        ...
        <div class="pull-right">
            ...
            <ul class="dropdown-menu pull-right">
                <li>
                    <a class="pjax" href="{$SELF_URL}/log/error">{lang('Errors log', 'exchange')}</a>
                </li>
                <li>
                    <a class="pjax" href="{$SELF_URL}/log/log">{lang('Query log', 'exchange')}</a>
                </li>
                <li>
                    <a class="pjax" href="{$SELF_URL}/log/time">{lang('Time log', 'exchange')}</a>
                </li>
            </ul>
        </div>
    </div>
