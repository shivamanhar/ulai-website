    <div class="container">
        ...
        <div class="row-fluid">
            ...
            <form method="POST" action="/admin/components/cp/wishlist/updateWL" id="property_ed_form">
                                ...
                                <div class="inside_padd">
                                    <div class="form-horizontal">
                                        <div class="control-group">
                                            <label class="control-label" for="banner_type">{lang('Name', 'wishlist')}: <span class="must">*</span></label>
                                            <div class="controls">
                ...
                <table class="table  table-bordered table-hover table-condensed t-l_a">
                    ...
                    <tbody>
                        ...
                        <td>
                            <input type="text" name="comment[{echo $w[variant_id]}]" value="{$w[comment]}" style="width: 100%;">
                        </td>
                    </tr>
                    {/foreach}
                </tbody>
            ...
            {/if}
            {form_csrf()}
            <button type="submit" class="btn btn-primary formSubmit" data-form="#property_ed_form"><i class="icon-white icon-ok"></i>{lang('Save', 'wishlist')}</button>
        </form>
        {/foreach}
    </div>
</section>
