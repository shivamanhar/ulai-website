                                ...
                                <div class="inside_padd">
                                    <div class="span12">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select id="category_sel" name="page_parent">
                                                    <option value="0">{lang("Root", "menu")}</option>													
                                                    {$sel = array($data.page_parent)}
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select id="per_page" name="per_page">
													{$position=array(10,15,20,30,40,50)}
													{$sel = $data.per_page}
													{foreach $position as $pos}													
														<option value="{$pos}" {if $pos == $sel}selected="selected"{/if}>{$pos}</option>
                                                    {/foreach}                                                 
                                                </select>
                                            </div>
                                        </div>										
