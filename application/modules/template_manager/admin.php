...
class Admin extends BaseAdminController {
     ...
     */
    const REMOTE_TEMPLATES_REPOSITORY = 'http://site.ua/addons/shop/remoteDownload/';
        ...
        if ($_POST) {
            ...
            \CMSFactory\assetManager::create()
                    ...
                    ->setData(array(
                        ...
                        'remoteTemplates' => $_GET['remote_templates'] ? TemplateManager::getInstance()->listRemote() : array(),
    ...
    public function get_template_license() {
        try {
            $template = new Template($_GET['template_name']);
    ...
    private function setLogoFav() {
        ...
        if ($_POST['si_delete_favicon'] == 1 && !$_FILES['siteinfo_favicon']) {
        ...
        if ($_POST['si_delete_logo'] == 1 && !$_FILES['siteinfo_logo']) {
