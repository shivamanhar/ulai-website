    ...
    <div class="center">
        {literal}
            <style type="text/css">
                ...
                /* This most probably won't work in all email clients. Don't include <code _tmplitem="957" > blocks in email. */
                code {
                    white-space: normal;
                    word-break: break-all;
                }
                #background-table {width: 700px; margin: auto;}
                /* Webkit Elements */
                ...
                #headline p { color: #e7cba3; font-family: 'Helvetica Neue', Arial, Helvetica, Geneva, sans-serif; font-size: 36px; text-align: center; margin-top:0px; margin-bottom:30px;  text-shadow: 0 2px 1px #FEFEFE !important; color: #1D9995 !important;}
                    ...
                    <td align="center" bgcolor="#ececec">
                        <table class="w640" style="margin:0 10px;" border="0" cellpadding="0" cellspacing="0" width="640">
                            <tbody>
                                        ...
                                        <table id="top-bar" class="w640" bgcolor="#00707b" border="0" cellpadding="0" cellspacing="0" width="640">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="w325" align="left" valign="middle" width="350"></td>
                                ...
                                <tr style="background-color: #ececec;">
                                    <td class="w640" height="30" bgcolor="#ececec" width="640"></td>
                                </tr>
                                <tr id="simple-content-row" style="background-color: #ececec;">
                                    <td class="w640" bgcolor="#ececec" width="640">
                                        <table class="w640" border="0" cellpadding="0" cellspacing="0" width="640">
                                            <tbody>
                                                <tr>
                                                    <td class="w30" width="30"></td>
                                    ...
                                    <td class="w640" width="640">
                                        <table id="footer" class="w640" bgcolor="#043948" border="0" cellpadding="0" cellspacing="0" width="640">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="w30" width="30"></td>
                                                    <td class="w580" valign="top" width="360"></td>
