...
*/
abstract class ShopKitProduct extends PropelBaseModelClass implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ShopKitProductTableMap';
    ...
    /**
     * Initializes internal state of Base\ShopKitProduct object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>ShopKitProduct</code> instance.  If
     * <code>obj</code> is an instance of <code>ShopKitProduct</code>, delegates to
     * <code>equals(ShopKitProduct)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ShopKitProduct The current object, for fluid interface
     */
     ...
     * @return $this|\ShopKitProduct The current object (for fluent API support)
     */
    public function setProductId($v)
    {
        ...
        if ($this->product_id !== $v) {
            $this->product_id = $v;
            $this->modifiedColumns[ShopKitProductTableMap::COL_PRODUCT_ID] = true;
        }
    ...
    public function setKitId($v)
    {
        ...
        if ($this->kit_id !== $v) {
            $this->kit_id = $v;
            $this->modifiedColumns[ShopKitProductTableMap::COL_KIT_ID] = true;
        }
    ...
    public function setDiscount($v)
    {
        ...
        if ($this->discount !== $v) {
            $this->discount = $v;
            $this->modifiedColumns[ShopKitProductTableMap::COL_DISCOUNT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ShopKitProductTableMap::translateFieldName('ProductId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->product_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ShopKitProductTableMap::translateFieldName('KitId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->kit_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ShopKitProductTableMap::translateFieldName('Discount', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = ShopKitProductTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ShopKitProduct'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildShopKitProductQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ShopKitProduct::setDeleted()
     * @see ShopKitProduct::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildShopKitProductQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ShopKitProductTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ShopKitProductTableMap::COL_PRODUCT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'product_id';
        }
        if ($this->isColumnModified(ShopKitProductTableMap::COL_KIT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'kit_id';
        }
        if ($this->isColumnModified(ShopKitProductTableMap::COL_DISCOUNT)) {
    ...
    {
        $pos = ShopKitProductTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ShopKitProduct'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ShopKitProduct'][$this->hashCode()] = true;
        $keys = ShopKitProductTableMap::getFieldNames($keyType);
        $result = array(
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aShopKit) {
                ...
                $result[$key] = $this->aShopKit->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ShopKitProductTableMap::COL_PRODUCT_ID)) {
            $criteria->add(ShopKitProductTableMap::COL_PRODUCT_ID, $this->product_id);
        }
        if ($this->isColumnModified(ShopKitProductTableMap::COL_KIT_ID)) {
            $criteria->add(ShopKitProductTableMap::COL_KIT_ID, $this->kit_id);
        }
        if ($this->isColumnModified(ShopKitProductTableMap::COL_DISCOUNT)) {
            $criteria->add(ShopKitProductTableMap::COL_DISCOUNT, $this->discount);
        }
    ...
    {
        $criteria = ChildShopKitProductQuery::create();
        $criteria->add(ShopKitProductTableMap::COL_PRODUCT_ID, $this->product_id);
        $criteria->add(ShopKitProductTableMap::COL_KIT_ID, $this->kit_id);
    ...
    public function hashCode()
    {
        ...
        //relation shop_kit_product_fk_6a9780 to table shop_products
        ...
        //relation shop_kit_product_fk_f2c410 to table shop_product_variants
        if ($this->aSProductVariants && $hash = spl_object_hash($this->aSProductVariants)) {
            $primaryKeyFKs[] = $hash;
        } else {
            $validPrimaryKeyFKs = false;
        }

        //relation shop_kit_product_fk_350dcb to table shop_kit
        if ($this->aShopKit && $hash = spl_object_hash($this->aShopKit)) {
            $primaryKeyFKs[] = $hash;
        } else {
            $validPrimaryKeyFKs = false;
        }
    ...
    public function getSProductVariants(ConnectionInterface $con = null)
    {
        if ($this->aSProductVariants === null && ($this->product_id !== null)) {
            $this->aSProductVariants = ChildSProductVariantsQuery::create()
    ...
    /**
     * Declares an association between this object and a ChildShopKit object.
     *
     * @param  ChildShopKit $v
     * @return $this|\ShopKitProduct The current object (for fluent API support)
     * @throws PropelException
     */
    public function setShopKit(ChildShopKit $v = null)
    {
        if ($v === null) {
            $this->setKitId(NULL);
        } else {
        ...
        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildShopKit object, it will not be re-added.
        if ($v !== null) {
            $v->addShopKitProduct($this);
        }
    ...
    /**
     * Get the associated ChildShopKit object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildShopKit The associated ChildShopKit object.
     * @throws PropelException
     */
    public function getShopKit(ConnectionInterface $con = null)
    {
        if ($this->aShopKit === null && ($this->kit_id !== null)) {
            $this->aShopKit = ChildShopKitQuery::create()->findPk($this->kit_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
    ...
    {
        if (null !== $this->aSProducts) {
            $this->aSProducts->removeShopKitProduct($this);
        }
        if (null !== $this->aSProductVariants) {
            $this->aSProductVariants->removeShopKitProduct($this);
        }
        if (null !== $this->aShopKit) {
            $this->aShopKit->removeShopKitProduct($this);
        }
    ...
    {
        return (string) $this->exportTo(ShopKitProductTableMap::DEFAULT_STRING_FORMAT);
    }
