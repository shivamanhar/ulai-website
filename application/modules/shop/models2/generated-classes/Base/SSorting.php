...
abstract class SSorting extends PropelBaseModelClass implements ActiveRecordInterface
{
    ...
    /**
     * The value for the name_front field.
     * @var        string
     */
    protected $name_front;
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[SSortingTableMap::COL_NAME] = true;
        }
    ...
    public function setNameFront($v)
    {
        ...
        if ($this->name_front !== $v) {
            $this->name_front = $v;
            $this->modifiedColumns[SSortingTableMap::COL_NAME_FRONT] = true;
        }
    ...
    public function setTooltip($v)
    {
        ...
        if ($this->tooltip !== $v) {
            $this->tooltip = $v;
            $this->modifiedColumns[SSortingTableMap::COL_TOOLTIP] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SSortingTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SSortingTableMap::translateFieldName('NameFront', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name_front = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SSortingTableMap::translateFieldName('Tooltip', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tooltip = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SSortingTableMap::translateFieldName('Get', TableMap::TYPE_PHPNAME, $indexType)];
            $this->get = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SSortingTableMap::translateFieldName('Active', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = SSortingTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SSortingTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(SSortingTableMap::COL_NAME_FRONT)) {
            $modifiedColumns[':p' . $index++]  = 'name_front';
        }
        if ($this->isColumnModified(SSortingTableMap::COL_TOOLTIP)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'name':
                        ...
                        break;
                    case 'name_front':
                        $stmt->bindValue($identifier, $this->name_front, PDO::PARAM_STR);
                        break;
                    case 'tooltip':
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setNameFront($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setTooltip($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setGet($arr[$keys[5]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SSortingTableMap::COL_NAME)) {
            $criteria->add(SSortingTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(SSortingTableMap::COL_NAME_FRONT)) {
            $criteria->add(SSortingTableMap::COL_NAME_FRONT, $this->name_front);
        }
        if ($this->isColumnModified(SSortingTableMap::COL_TOOLTIP)) {
            $criteria->add(SSortingTableMap::COL_TOOLTIP, $this->tooltip);
        }
        if ($this->isColumnModified(SSortingTableMap::COL_GET)) {
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setNameFront($this->getNameFront());
