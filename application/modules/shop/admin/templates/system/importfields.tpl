...
<div style="border: 1px #fff solid; padding: 10px; margin: 40px 40px 100px;overflow: hidden;" id="importcsvholder">
    <div class="imortcsvstepone">
        <div style="width:500px;float: left">
            <form method="post" action="{$ADMIN_URL}system/importscv"  enctype="multipart/form-data">
                ...
                <div class="form_text">{lang('Fields separator','admin')}:</div>
                <div class="form_input">
                ...
                <div class="form_input">
                    <input type="submit" value="{lang('Import','admin')}" id="submitform" class="button_130"/>
                </div>
    ...
    <div style="float:left;">
        ...
        <div class="form_input">
            <table cellpadding="1" cellspacing="3" style="font-size:11px" class="attributesTable">
                ...
                <tr class="even" onclick="addProductColumn(this)"><td>name</td><td>   {lang('Product Name','admin')}</td></tr>
                ...
                <tr class="even" onclick="addProductColumn(this)"><td>mimg </td><td>  {lang('Main image','admin')}</td></tr>
    ...
    <script type="text/javascript">
        ...
        function fileUploadCallback()
        {
            ...
            if (data != '')
            {
                ...
                $('errorsBox').set('html', '');
                showMessage('', lang('Import Complete','admin'));
            }
        }
    </script>
{/literal}
