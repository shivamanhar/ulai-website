    ...
    <div class="frame_title clearfix">
        ...
        <div class="pull-right">
            <div class="d-i_b">
                ...
                <a class="btn btn-small btn-success pjax" href="/admin/components/run/shop/rbac/group_create" ><i class="icon-plus-sign icon-white"></i>{lang('Create group of roles','admin')}</a>
            </div>
        </div>  
    </div>
...
<div class="modal hide fade">
    ...
    <div class="modal-footer">
        ...
        <a href="" class="btn btn-primary" onclick="shopCategories.deleteCategoriesConfirm();
                        $('.modal').modal('hide');">{lang('Delete','admin')}</a>
    </div>
</div>