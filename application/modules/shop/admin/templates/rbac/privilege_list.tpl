<section class="mini-layout">
    <div class="frame_title clearfix">
        ...
        <div class="pull-right">
            <div class="d-i_b">
                ...
                <a class="btn btn-small btn-success pjax" href="/admin/components/run/shop/rbac/privilege_create" ><i class="icon-plus-sign icon-white"></i>{lang('Create privilege','admin')}</a>
            </div>
        </div>  
    </div>
    <div class="tab-content">
        {if count($model)>0}
        <div class="row-fluid">
            <form method="post" action="#" class="form-horizontal" data-url-delete="/admin/components/run/shop/rbac/privilege_delete">
                <table class="table  table-bordered table-hover table-condensed">
                    ...
                    <tbody class="sortable" id="rltbl">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="pjax" href="/admin/components/run/shop/rbac/privilege_edit/{echo $item->getId()}">{echo ShopCore::encode($item->getName())}</a>
                            </td>
                            <td>
        ...
        <div class="alert alert-info">
            {lang('List','admin')} {lang('Privileges','admin')} {lang('Empty.','admin')}
        </div>
        {/if}
    </div>
</section>
