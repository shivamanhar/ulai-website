<section class="mini-layout">
    <div class="frame_title clearfix">
        ...
        <div class="pull-right">
            <div class="d-i_b">
                <a href="{echo $back_url}" class="t-d_n m-r_15 pjax"><span class="f-s_14">←</span> <span class="t-d_u">{lang('Back','admin')}</span></a>
    ...
    <form id="editUsers" action="{$ADMIN_URL}users/edit/{echo $model->getId()}" method="post" class="form-horizontal">
        <div class="row-fluid m-t_20">
            <div class="span6">
                <table class="table  table-bordered table-hover table-condensed content_big_td m-b_0">
                    <thead>
                        <tr>
                            <th colspan="6">                                
        ...
        {if count($ordersModel)}
            <div class="title-default">{lang('Purchase history', 'admin')}</div>
            <table class="table  table-bordered table-hover table-condensed t-l_a">
                <thead>
                    <tr>
