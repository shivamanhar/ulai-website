        ...
        <div class="row-fluid">
            ...
            <div class="tabbable">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active">
                        <a href="#modules" data-toggle="tab">{lang('Modules', 'translator')}</a>
                    </li>
                {/if}
                    {if $searchResult['templates']}
                        <li>
                            <a href="#templates" data-toggle="tab">{lang('Templates', 'translator')}</a>
                        </li>
                    {/if}
                    {if $searchResult['main']}
                        <li>
                            <a href="#main" data-toggle="tab">{lang('Main', 'translator')}</a>
                        </li>
                    {/if}
                </ul>
                                    ...
                                    <tr>
                                        ...
                                        <td class="share_alt">
                                            <button onclick="Search.updateOne(this)" type="button"
                                                    ...
                                                    data-original-title="{lang('Update', 'translator')}"
                                                    data-rel="tooltip">
