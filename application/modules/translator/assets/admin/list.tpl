        ...
        <div class="statistic">
            <table class="table-bordered">
                <tr>
                    ...
                    <td><b>{lang('Not translated', 'translator')}: <span class="notTranslatedStringsCount"></span></b></td>
                </tr>
            </table>
        </div>
                ...
                <div class="tab-pane active" id="poTab">
                    ...
                    <div class="pull-right">
                        <div class="input-append poSearchHolder">
                            ...
                            <button id="searchTranslator" class="btn" type="button"><i class="icon-search" style="margin-right: 0;"></i></button>
                                    ...
                                    <tr>
                                        <th colspan="3" >
                                            ...
                                            <div class="additionalSearchPaths" style="float: right; margin-top: 5px; font-weight: normal">
                                                ...
                                                <div class="d_n">
                                                    {lang('You can hold and translate phrases from modules and Main translation file in this file', 'translator')}.<br/>
                                                    {lang('Choose one from list, it will be added', 'translator')}.
                                                </div>
                                                <select onchange="Translator.addAdditionalPath(this)" style="width: 300px;">
                                                    <option value="">-- {lang('Add additional search place','translator')} --</option>
                                                    <option value="main">{lang('Main', 'translator')}</option>
                                                    {foreach $modules as $module}
                                                    <option value="{echo $module['com_name']}">{echo lang('Module', 'translator')}: {echo $module['menu_name']}</option>
                                                    {/foreach}
                                                </select>
                                            </div>
                                        </th>
