...
<section class="mini-layout">
    <div class="frame_title clearfix">
        <div class="pull-left">
            ...
            <span class="title">{lang('Mobile version settings', 'mobile')}</span>
        </div>
        <div class="pull-right">
            <div class="d-i_b">
                ...
                <button type="button" class="btn btn-small btn-primary action_on formSubmit" data-form="#settings_form"><i class="icon-ok"></i>{lang('Save', 'mobile')}</button>
                        ...
                        <tr>
                            <td colspan="6">
                                <div class="inside_padd span9">
                                    ...
                                    {else:}
                                        {lang('Patern list is empty', 'mobile')}.
                                    {/if}
