                    ...
                    <div class="top_frame_tov">
                        <a href="{echo shop_url('product/'.$item->getSProducts()->getUrl())}" class="t-d_n">
                            ...
                            <span class="descr">
                                ...
                                {/if}
 <span class="d_b price">{echo \Currency\Currency::create()->getCurrencyToFormat(\Currency\Currency::create()->getMainCurrency()->getId(), ShopCore::app()->SCurrencyHelper->convert($item->price),'', '', '',  '', '', '');}</span> 
                            </span>
                        </a>
                        <span class="descr">
...
{echo \Currency\Currency::create()->getCurrencyToFormat(\Currency\Currency::create()->getMainCurrency()->getId(), ShopCore::app()->SCurrencyHelper->convert($gift_val),'', '', '',  '', '', '');}
                    {if $gift_key}
                ...
                <br/>
                {if $discount_val}
 {lang('Скидка', 'commerce_mobiles')}: {echo \Currency\Currency::create()->getCurrencyToFormat(\Currency\Currency::create()->getMainCurrency()->getId(), ShopCore::app()->SCurrencyHelper->convert($discount_val),'span', 'curr', '',  'span', 'price f-w_b', '');} <br/> 
                {/if}
                <span class="total_pay">{lang('Всего к оплате', 'commerce_mobiles')}:</span>
                <span class="price">
{echo \Currency\Currency::create()->getCurrencyToFormat(\Currency\Currency::create()->getMainCurrency()->getId(), ShopCore::app()->SCurrencyHelper->convert($cartPrice),'', '', '',  '', '', '');}
                </span>
            </div>
        </div>
