    ...
    <li>
        <div class="top_frame_tov">
            ...
            <div class="descr">
                ...
                {if $hasDiscounts}
<span class="d_b price" style="color: red; text-decoration: line-through;">{echo \Currency\Currency::create()->getCurrencyToFormat(\Currency\Currency::create()->getMainCurrency()->getId(), $model->firstVariant->toCurrency('OrigPrice'),'', '', '',  '', '', '')}</span> 
                {/if}
                <!-- End. Check for discount-->
                <!-- Start. Check old price-->
                {if $oldoprice && !$hasDiscounts}
 <span class="d_b price" style="color: red; text-decoration: line-through;">{echo \Currency\Currency::create()->getCurrencyToFormat(\Currency\Currency::create()->getMainCurrency()->getId(), intval($model->toCurrency('OldPrice')),'', '', '',  '', '', '')}</span> 
                {/if}
                <!-- End. Check old price-->
<span class="d_b price">{echo \Currency\Currency::create()->getCurrencyToFormat(\Currency\Currency::create()->getMainCurrency()->getId(), $model->firstVariant->toCurrency(),'', '', '',  '', '', '')}</span> 
