...
<td>-{echo \Currency\Currency::create()->getCurrencyToFormat(\Currenc\Currency::create()->getMainCurrency()->getId(), $discount,'', '', '',  '', '', '')}</td> 
        </tr>
    {/if}
...
<span class="price"> {echo \Currency\Currency::create()->getCurrencyToFormat(\Currency\Currency::create()->getMainCurrency()->getId(), $cartPrice,'', '', '',  '', '')}</span> 
