                                        ...
                                        <div class="frame-prices f-s_0">
                                            ...
                                            {if $hasDiscounts}
                                                <span class="price-discount">
                                                    <span>
{echo \Currency\Currency::create()->getCurrencyToFormat(\Currency\Currency::create()->getMainCurrency()->getId(), $model->firstVariant->toCurrency('OrigPrice'),'span', 'curr', '',  'span', 'price priceOrigVariant', '')}
                                            ...
                                            {if $oldoprice && !$hasDiscounts}
                                                <span class="price-discount">
                                                    <span>
{echo \Currency\Currency::create()->getCurrencyToFormat(\Currency\Currency::create()->getMainCurrency()->getId(), intval($model->toCurrency('OldPrice')),'span', 'curr', '',  'span', 'price priceOrigVariant', '')}
                                            ...
                                            <!-- End. Check old price-->
                                            <!-- Start. Product price-->
                                            {if is_numeric($model->firstVariant->toCurrency())}
                                                <span class="current-prices f-s_0">
                                                    <span class="price-new">
                                                        <span>
{echo \Currency\Currency::create()->getCurrencyToFormat(\Currency\Currency::create()->getMainCurrency()->getId(), $model->firstVariant->toCurrency(),'span', 'curr', '',  'span', 'price priceVariant', '')}
                                                    ...
                                                    {if $NextCSIdCond}
                                                        ...
                                                        <span>
({echo \Currency\Currency::create()->getCurrencyToFormat($NextCSId, $model->firstVariant->toCurrency('Price',$NextCSId),'span', 'curr-add', '',  'span', 'price addCurrPrice', '')})
                                                            ...
                                                            <div class="js-variant-{echo $productVariant->getId()} js-variant" {if $key != 0}style="display:none"{/if}>
                                                                ...
                                                                <div class="btn-not-avail">
                                                                    <button
                                                                            ...
                                                                            data-add-price="{if $NextCSIdCond}{echo $productVariant->toCurrency('Price',$NextCSId,true)}{/if}"
                                                                            data-orig-price="{if $hasDiscounts}{echo $productVariant->toCurrency('OrigPrice',null,true)}{/if}"
                                                                            data-templateprice ="{echo \Currency\Currency::create()->getCurrencyToFormat(\Currency\Currency::create()->getMainCurrency()->getId(), $productVariant->toCurrency('Price',null,true))}"
                                                                            data-templatepriceadd ="{if $NextCSIdCond}{echo \Currency\Currency::create()->getCurrencyToFormat($NextCSId, $productVariant->toCurrency('Price',$NextCSId,true))}{/if}"
                                                                            data-templatepricedisc ="{if $hasDiscounts}{echo \Currency\Currency::create()->getCurrencyToFormat(\Currency\Currency::create()->getMainCurrency()->getId(), $productVariant->toCurrency('OrigPrice',null,true))}{/if}"
                                                                            data-large-image="
                                                        {if preg_match('/nophoto/', $productVariant->getlargePhoto()) > 0}
                                                        {echo $model->firstVariant->getlargePhoto()}
                                                        {else:}
                                        ...
                                        {foreach $model->getShopKitsLoggedUsersCheck($CI->dx_auth->is_logged_in()) as $key => $kitProducts}
                                            ...
                                            <span class="photo-block">
                                                ...
                                                <span class="current-prices f-s_0">
                                                    <span class="price-new">
                                                        <span>
{echo \Currency\Currency::create()->getCurrencyToFormat(\Currency\Currency::create()->getMainCurrency()->getId(), $kitProducts->getMainProductPrice(),'span', 'curr', '',  'span', 'price priceVariant', '')}
...
({echo \Currency\Currency::create()->getCurrencyToFormat($NextCSId, $kitProducts->getMainProductPrice($NextCSId),'span', 'curr-add', '',  'span', 'price addCurrPrice', '')})
                                                                ...
                                                                <div class="description">
                                                                    <div class="frame-prices f-s_0">
                                                                        ...
                                                                        {if $kitProduct->getDiscount()}
                                                                            <span class="price-discount">
                                                    <span>
{echo \Currency\Currency::create()->getCurrencyToFormat(\Currency\Currency::create()->getMainCurrency()->getId(), $kitProduct->getKitProductPrice(),'span', 'curr', '',  'span', 'price priceOrigVariant', '')}
                                                ...
                                                <span class="current-prices f-s_0">
                                                    <span class="price-new">
                                                        <span>
{echo \Currency\Currency::create()->getCurrencyToFormat(\Currency\Currency::create()->getMainCurrency()->getId(), $kitProduct->getKitNewPrice(),'span', 'curr', '',  'span', 'price priceVariant', '')}
                                                    ...
                                                    {if $NextCSIdCond}
                                                        <span class="price-add">
                                                        <span>
({echo \Currency\Currency::create()->getCurrencyToFormat($NextCSId, $kitProduct->getKitNewPrice($NextCSId),'span', 'curr-add', '',  'span', 'price addCurrPrice', '')})
                                        ...
                                        <span class="price-discount">
                                            <span>
{echo \Currency\Currency::create()->getCurrencyToFormat(\Currency\Currency::create()->getMainCurrency()->getId(), $kitProducts->getTotalPriceOld(),'span', 'curr', '',  'span', 'price', '')}
...
({echo \Currency\Currency::create()->getCurrencyToFormat($NextCSId, $kitProducts->getTotalPrice($NextCSId),'span', 'curr-add', '',  'span', 'price ', '')})
                ...
                <div class="f-s_0">
                    <ul class="tabs tabs-data tabs-product">
                        {$dl_properties = ShopCore::app()->SPropertiesRenderer->renderPropertiesTableNew($model->getId())}
                        {$fullDescription = $model->getFullDescription()}
                        {if $dl_properties && $fullDescription != '' && $accessories}
                            <li class="active">
                    ...
                    <div class="right-social">
                        <div class="vertical-carousel similar-product">
                            <section class="special-proposition">
                                <div class="frame-title">
                                    <div class="title">
                                        <span class="text-el text-proposition-v">{lang('Понравился товар?','light')}</span>
                                    </div>
                                </div>
                                <div class="inside-padd">
                                    <!--Start .Share-->
                                    <dl class="social-product">
                                        ...
                                        <dd class="social-tell d_i-b">
                                            <span class="text-el d_i-b v-a_m">{lang('Поделитесь','light')}</span>
                                            <div class="d_i-b v-a_m">
