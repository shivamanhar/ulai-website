    ...
    <div class="container">
        <div class="right-catalog" {if !$totalProducts > 0}style="width:100% !important"{/if}>
            <div class="f-s_0 title-category">
                ...
                <span class="count">({lang('Найдено','light')} {$totalProducts} {echo SStringHelper::Pluralize($totalProducts, array(lang('товар','light'),lang('товара','light'),lang('товаров','light')))})</span>
            </div>
            {if $totalProducts == 0}
                <div class="msg layout-highlight layout-highlight-msg">
                    <div class="info">
                        <span class="icon_info"></span>
                        <span class="text-el">{lang('По вашему запросу товаров не найдено','light')}</span>
                    </div>
                </div>
            {/if}
                ...
                <div class="frame-category-menu layout-highlight">
                    <div class="title-menu-category">
                        <div class="title-default">
                            <div class="title-h3 title">{lang('Найдено в категориях:','light')}</div>
                        </div>
                    </div>
