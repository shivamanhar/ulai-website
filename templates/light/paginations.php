...
$categoryPagination['next_tag_open'] = '<li class="next-page">';
$categoryPagination['next_tag_close'] = '</li>';
$categoryPagination['prev_tag_open'] = '<li class="prev-page">';
$categoryPagination['prev_tag_close'] = '</li>';
...
$brandPagination['next_tag_open'] = '<li class="next-page">';
$brandPagination['next_tag_close'] = '</li>';
$brandPagination['prev_tag_open'] = '<li class="prev-page">';
$brandPagination['prev_tag_close'] = '</li>';
/**
...
$searchPagination['next_tag_open'] = '<li class="next-page">';
$searchPagination['next_tag_close'] = '</li>';
$searchPagination['prev_tag_open'] = '<li class="prev-page">';
$searchPagination['prev_tag_close'] = '</li>';
