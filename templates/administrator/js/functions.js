...
function initTinyMCE()
{
    ...
    try {
			 ...
			 //   var length = tinymce.editors.length ? tinymce.editors.length : -1;
              ...
              tinymce.init({
                ...
                image_advtab: true,
                toolbar: "undo redo | styleselect | bold italic underline | forecolor | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image | highlightcode | danger | spellchecker | save_button | fullscreen",
...
var orders = new Object({
    ...
    deleteOrders: function () {
        $('.modal:not(.addNotificationMessage)').modal();
    },
