        ...
        $('#AttachedProducts').autocomplete({
            ...
            select: function (event, ui) {
                ...
                $('#forAttached').append('<div id="tpm_row' + ui.item.identifier.id + '" class="m-t_10">' +
                    ...
                    '<input type="text" id="AttachedProductsDisc" name="Discounts[]" value="0" class="input-mini" data-max="100" data-rel="tooltip" data-title="' + lang('numbers only') + '"/>' +
                    '</span>&nbsp;' +
                    '<span class="d-i_b v-a_b">' +
    ...
    $('#RelatedProducts').autocomplete({
        ...
        select: function (event, ui) {
            $('<tr id="tpm_row' + ui.item.identifier.id + '" class="item-accessories"><td>\n\
                ...
                (ui.item.photo ? '<img src="' + ui.item.photo + '" class="img-polaroid" style="width: 100px;max-height: 100%;">' : '<img src="' + (base_url + 'templates/administrator/images/select-picture.png') + '" class="img-polaroid" style="width: 100px;max-height: 100%;">')
                +
                '<div class="o_h">\n\
