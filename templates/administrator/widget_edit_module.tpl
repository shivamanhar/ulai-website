<section class="mini-layout">
    ...
    <form method="post" action="" class="form-horizontal m-t_10" id="wid_ed_form">
                    ...
                    <td colspan="6">
                        <div class="inside_padd">
                            <div class="control-group m-t_10">
                                <label class="control-label" for="inputtitle">{lang("Title","admin")}:</label>
                                <div class="controls">
                                    <input type="text" name="title" id="inputtitle" value="{$widget.title}"/>
                                </div>
                            </div>
                            <div class="control-group m-t_10">
